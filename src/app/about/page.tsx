    ...
    <section className="text-black-primary">
      ...
      <div className="mx-auto mb-12 mt-8 flex flex-col items-center justify-center md:gap-10 lg:flex-row">
        ...
        <p className="mt-5 text-justify text-base text-secondary-text md:mt-0 lg:w-1/2 xl:text-lg">
          Hello! I am Daniel, an active student in the 6th semester majoring in{' '}
          <b>Informatics Engineering</b> at Universitas Tarumanagara. I possess
          ...
          <br />
          <br />I have hands-on experience with <b>PHP</b> and <b>NodeJS</b>{' '}
          for the frontend. and using <b>ExpressJS</b>, <b>Laravel</b> for
          backend development. im also currently learning about <b>MongoDB and Postgre</b>{' '}
          for Web development and use Dart and Flutter for Mobile development
        </p>
      </div>
      <TextSection
        icon="💼"
      ...
      <TextSection
        ...
        text="Tech Stack That I Use and Learn."
      />
