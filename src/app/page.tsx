  ...
  return (
    ...
    >
      ...
      >
        ...
        <ScrambleText>Daniel Hartono</ScrambleText>
        ...
        <p className="max-w-lg text-center text-sm dark:text-white md:max-w-2xl md:text-left md:text-base">
          I am a <b>Web Developer</b> from Indonesia, I have a Learn
          understanding of programming languages and have experience in{' '}
          <b>Web Developer and IT Support Software and Hardware</b> projects.
        </p>
